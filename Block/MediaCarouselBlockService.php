...
class MediaCarouselBlockService extends BaseBlockService
{
    ...
    public function setDefaultSettings(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
                                   ...
                                   'interval' => 5000,
                                   'pause' => 'hover',
                                   'template'  => 'RzMediaBundle:Block:block_media_carousel.html.twig',
                                   'galleryId' => false
                               ));
    }
    ...
    public function buildEditForm(FormMapper $formMapper, BlockInterface $block)
    {
        ...
        $formMapper->add('settings', 'sonata_type_immutable_array', array(
                                       'keys' => array(
                                           ...
                                           array('interval', 'number', array('attr'=>array('class'=>'span8'))),
                                           array('pause', 'choice', array(
    ...
    {
        return array(
            '/bundles/rzmedia/css/block/rzmedia-carousel.css'
        );
    }
    ...
    {
        return array(
            '/bundles/rzmedia/js/block/rzmedia-carousel.js'
        );
    }
